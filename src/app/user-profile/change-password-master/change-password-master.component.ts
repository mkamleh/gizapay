...
@Component({
  selector: "app-change-password-master",
  templateUrl: "./change-password-master.component.html",
  styleUrls: ["./change-password-master.component.scss"],
})
export class ChangePasswordMasterComponent implements OnInit {
  ...
  async changePassword() {
    ...
    if (this.changePasswordForm.valid) {
      this.httpClientService.httpClientMainRouter("WRMAL_058",`null`,"PUT",data)
      .subscribe( async res => {
